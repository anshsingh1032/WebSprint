...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 relative overflow-hidden font-sans">
      ...
      <div className="pointer-events-none absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-violet-300/40 rounded-full mix-blend-multiply filter blur-[100px] opacity-70 animate-pulse"></div>
      <div className="pointer-events-none absolute top-[20%] right-[-5%] w-[400px] h-[400px] bg-fuchsia-300/40 rounded-full mix-blend-multiply filter blur-[100px] opacity-70 animate-pulse" style={{ animationDelay: '2s' }}></div>
      <div className="pointer-events-none absolute bottom-[-10%] left-[20%] w-[600px] h-[600px] bg-cyan-300/30 rounded-full mix-blend-multiply filter blur-[100px] opacity-70 animate-pulse" style={{ animationDelay: '4s' }}></div>
